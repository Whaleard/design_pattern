...
class B2 implements Interface11, Interface12 {
...
class D2 implements Interface11, Interface13 {
...
/**
 * A2类通过接口Interface11，Interface12依赖B类，但是只会用到1,2,3方法
 */
class A2 {
...
/**
 * C2类通过接口Interface11，Interface13依赖D类，但是只会用到1,4,5方法
 */
class C2 {
    public void depend1(Interface11 i) {
        i.operation1();
